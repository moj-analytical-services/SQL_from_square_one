...
We encourage you to write literate SQL using Common Table Expressions, and if you are an RStudio user, to write and run SQL from there. The next two pages in this guide cover these topics.