...
SQL can be difficult for others to read if the logic becomes complex. Particularly if you use [nested SQL](https://www.tutorialspoint.com/sql/sql-sub-queries.htm). While nested SQL can create elegant solutions this can make the code harder to read and QA.

Common Table Expressions are a simple way to make your SQL code easier to read, much like a story. This is sometimes called [literate SQL](https://modern-sql.com/use-case/literate-sql){target="_blank"} or [literate programming](https://en.wikipedia.org/wiki/Literate_programming){target="_blank"}.

Below are two demonstrations of CTEs. Please also review this very clear tutorial on [essentialsql.com](https://www.essentialsql.com/introduction-common-table-expressions-ctes/){target="_blank"}. It describes CTEs visually by highlighting key parts of the SQL code when using CTEs. Also, try modules 10 to 12 of the Oracle [Subqueries](https://livesql.oracle.com/apex/livesql/file/tutorial_GMLYIBY74FPBS888XO8F1R95I.html){target="_blank"} tutorial. 

# Example use of a Common Table Expression
